...
- `npm run build`: passed with Vite `8.3.1`; build reports the existing 544 kB JavaScript chunk exceeds its 500 kB advisory threshold.
...
- The production bundle still triggers Vite's chunk-size advisory; code splitting is outside this task.
